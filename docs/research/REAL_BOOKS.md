...
| *Three Men in a Boat* | Jerome K. Jerome, 1889 (PD) | The idler's indignation: long, reasonable sentences building to an unreasonable grievance; "I like work: it fascinates me"; the tin of pineapple, the tow-line, Harris. | Genuine excerpts in the toast; `jerome` pack and register at level 7. |
| *Dungeon Crawler Carl* (crib notes) | Matt Dinniman, 2020– (in copyright; summary only, no text quoted) | The announcer's achievement voice; a man shouting at a cat that outranks him. The oath "Goddamnit, Donut!" | `crawler` pack and register at level 6; while it is hot every unnamed sheep is addressed as Donut. |

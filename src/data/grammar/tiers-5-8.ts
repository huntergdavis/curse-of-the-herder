...
export const NON_TERMINALS_5_8: NonTerminal[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { t: "the #target# is #adj# and I am #adj#", weight: 2 },
      { t: "#remaining# sheep yet roam", weight: 2 },
      { t: "thou hast #verb.ed# enough", weight: 1 },
      { t: "I am #adj# past all bearing", weight: 1 },
...
export const RULES_5_8: Rule[] = [
  ...
  ...R(5, "dusk", ["The light goes, #oath#, and #remaining# #insult.pl# have not.", "Dusk #aside#, and I am as #adj# as #simile#."], GROSE),
  ...
  ...R(6, "caught", [
    "Now, #bard_np#, I have thee, and thou art heavy.", "Thou art caught, #vocative#, and I am #adj#; we are neither of us pleased.",
  ...
  ...R(6, "dusk", ["The light doth fail, and #remaining# sheep do not.", "Dusk, #oath#, and I am #adj# as #simile#."], BARD),
  ...
  ...R(6, "rain", ["Rain! #oath.cap#, the heavens are #adj# too!", "It rains, and I am #adj#, and the #target# is #adj#er."], BARD),

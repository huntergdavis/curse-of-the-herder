...
export const groseVulgarTongue: LexPack = {
  ...
  entries: [
    ...
    g(ins("gaby"), "a simpleton"), g(ins("gape-seed"), "one who stares at everything"), g(ins("gawney"), "a gawping simpleton"), g(ins("gobbler"), "a greedy eater"),
    ...
    g(ins("dew-beater"), "a great heavy foot; one who tramples the dew"), g(ins("dilly-dallier"), "one who trifles away time"), g(ins("fumbler"), "an awkward, bungling person"),
    g(ins("gormagon"), "a monster of no sense"), g(ins("lollpoop"), "a lazy, idle drone"), g(ins("skipkennel"), "a footman who leaps the gutter"), g(ins("stick-in-the-mud"), "one who never moves"),
    g(ins("dundering rascal"), "a noisy, blundering rogue"), g(ins("blowse"), "a red-faced blusterer"), g(ins("hobbledehoy"), "a gangling youth, neither one thing nor another"),
    ...
    g(ins("noodle"), "a simpleton"), g(ins("goosecap"), "a silly fellow"), g(ins("rum touch"), "an odd, unaccountable fellow"), g(ins("quiz"), "an odd-looking, odd-acting fellow"),
    // Adjectives.
    ...
    g(adj("peery"), "suspicious, sly"), g(adj("queasy"), "sick at the stomach"), g(adj("rantipoling"), "wild and romping"), g(adj("rum"), "odd of temper; also fine"),
    g(adj("shabbaroon"), "shabby and mean"), g(adj("slubbering"), "slobbering and slovenly"), g(adj("snuffling"), "sniffing and whining"), g(adj("squab"), "soft, fat-cushioned (of a seat)"),
    g(adj("tatterdemalion"), "ragged"), g(adj("tantadlin"), "small and silly"), g(adj("waddling"), "walking like a duck"), g(adj("wamble-cropped"), "sick in the stomach"),
    g(adj("hum-drum"), "dull and tedious"), g(adj("blowsy"), "red-faced and dishevelled from wind"), g(adj("crank"), "unsteady, liable to topple"), g(adj("dilberry-ridden"), "with burrs in the wool"),
    ...
    g(n("bumbaste"), "a beating"), g(n("clack"), "chatter, noise"), g(n("dilberry"), "a burr stuck in wool"), g(n("fidlam ben"), "a petty theft"), g(n("gab"), "talk, prattle"),
    ...
    g(abs("blue devils"), "despondency"), g(abs("hipping"), "melancholy"), g(abs("mubble-fubbles"), "a fit of gloom"),
...
export const bard: LexPack = {
  ...
  entries: [
    ...
    b(adj("bunch-backed", { syl: 2 }), "hunched over a load"), b(adj("clay-brained", { syl: 2 })), b(adj("currish", { syl: 2 })), b(adj("dismal-dreaming", { syl: 4 })), b(adj("dissembling", { syl: 3 })),
    ...
    b(adj("threadbare", { syl: 2 })), b(adj("elf-skinned", { syl: 2 })), b(adj("plume-plucked", { syl: 2 })), b(adj("pox-marked", { syl: 2, band: 1 })),
    ...
    b(ins("knave")), b(ins("mouldy rogue")), b(ins("natural"), "a simpleton, in the old sense"), b(ins("patch"), "a fool in motley"),
    b(ins("peasant")), b(ins("popinjay")), b(ins("rabbit-sucker")), b(ins("rudesby")), b(ins("scullion")), b(ins("stockfish"), "dried cod"), b(ins("tallow-catch")), b(ins("three-inch fool")),
    b(ins("tickle-brain")), b(ins("toad")), b(ins("cream-faced loon"), "loon: a rogue, in the old sense"), b(ins("bolting-hutch"), "a flour bin"),
...
export const french: LexPack = {
  ...
  entries: [
    ...
    f(inten("satané", 1), "confounded"), f(inten("espèce de", 0), "you sort of...; prefix to insults"),
...
export const german: LexPack = {
  ...
  entries: [
    ...
    d(inten("verdammt", 2), "damned"), d(inten("verflixt", 1), "confounded"), d(inten("saublöd", 1), "pig-silly; utterly daft"), d(inten("stink-", 0), "stinking-; prefix"),
...
export const yiddishScotsAussie: LexPack = {
  ...
  entries: [
    ...
    sc(ins("dafty", { pl: "dafties" }), "a daft one"), sc(ins("galoot", { pl: "galoots" }), "a clumsy lout"), sc(ins("tumshie", { pl: "tumshies" }), "a turnip; a fool"), sc(ins("bawbag", { pl: "bawbags", band: 3 }), "scrotum; a contemptible person"),
    sc(ins("dobber", { pl: "dobbers", band: 2 }), "an oaf"), sc(ins("roaster", { pl: "roasters" }), "a ridiculous, loud fool"), sc(ins("sumph", { pl: "sumphs" }), "a soft, slow fellow"), sc(ins("gowk", { pl: "gowks" }), "a cuckoo; a fool"),
    ...
    sc(adj("glaikit"), "vacant, foolish"), sc(adj("wee"), "small"), sc(adj("dreich"), "dreary, wet and grey"), sc(adj("boggin"), "filthy, disgusting"), sc(adj("mingin"), "smelly"), sc(adj("drookit"), "soaked through"),
    ...
    sc(n("jobby", { band: 2 }), "a turd"), sc(n("dreich", { pl: "-" }), "dreary weather"), sc(abs("the scunner"), "disgust, weariness"), sc(verb("haver"), "to talk nonsense"), sc(verb("greet"), "to weep"),
    sc(verb("trauchle"), "to trudge wearily"), sc(sim("a wet week in Greenock"), "dismal"), sc(sim("a piper with nae wind"), "useless"),
    au(ins("galah", { pl: "galahs" }), "a pink cockatoo; a loud fool"), au(ins("drongo", { pl: "drongos" }), "a bird; a hopeless fool"), au(ins("dropkick", { pl: "dropkicks" }), "a useless person"),
    ...
    au(ins("flamin' galah", { pl: "flamin' galahs" }), "a flaming fool"), au(ins("whacker", { pl: "whackers" }), "a fool"), au(ins("dag", { pl: "dags" }), "a matted lock of wool; an unfashionable oddball"),
...
export const quebecSacres: LexPack = {
  ...
  entries: [
    ...
    q(ins("épais", { pl: "épais" }), "(m.) un épais: a thick one"), q(ins("niaiseux", { pl: "niaiseux" }), "(m.) un niaiseux: a silly one"), q(ins("innocent", { pl: "innocents" }), "(m.) un innocent: a simpleton"),
    ...
    q(adj("niaiseux"), "silly"), q(adj("épais"), "thick"), q(adj("plate"), "flat; boring"), q(adj("écoeurant", { band: 1 }), "sickening; also, amazing"), q(adj("frette"), "cold"), q(adj("mouillé"), "wet"),

...
export const farmyard: LexPack = {
  ...
  level: 1,
  entries: [
    adj("soggy"), adj("heavy"), adj("wet"), adj("cold"), adj("muddy"), adj("slow"), adj("lumpy"), adj("woolly"), adj("stubborn"), adj("damp"),
    adj("sodden"), adj("daft"), adj("silly"), adj("steep"), adj("prickly"), adj("itchy"), adj("sticky"), adj("greasy"),
    adj("smelly"), adj("dripping"), adj("bleating"), adj("wobbly"), adj("useless"), adj("hopeless"), adj("wretched"), adj("miserable"), adj("dreadful"),
    adj("rotten"), adj("pointless"), adj("endless"), adj("thankless"), adj("bothersome"), adj("tiresome"), adj("blasted", { band: 1 }),
    adj("bony"),
    adj("chewy"), adj("windy"), adj("rainy"), adj("foggy"), adj("boggy"), adj("rocky"), adj("thorny"), adj("weedy"), adj("mossy"), adj("dank"),
    adj("clammy"), adj("squelchy"), adj("slimy"), adj("gritty"), adj("crumbly"), adj("soppy"), adj("dozy"), adj("ornery"), adj("cussed"),
...
export const insultsClassic: LexPack = {
  ...
  entries: [
    ...
    ins("disappointment"), ins("nuisance"), ins("menace"), ins("liability"), ins("mistake"), ins("inconvenience"), ins("obstacle"),
    adj("doltish"), adj("oafish"), adj("addle-pated"), adj("mutton-headed"), adj("thick-fleeced"), adj("half-baked"), adj("wool-brained"),
    adj("muddle-headed"), adj("cack-handed", { band: 1 }), adj("hare-brained"), adj("ham-fisted"), adj("slack-jawed"), adj("cud-chewing"),
    adj("mud-caked"), adj("moss-covered"), adj("weather-beaten"), adj("rain-soaked"), adj("wind-blown"), adj("dew-dampened"), adj("burr-ridden"),
    adj("knock-kneed"), adj("bandy-legged"), adj("flat-footed"), adj("four-footed"), adj("flea-bitten"), adj("moth-eaten"), adj("worm-eaten"),
...
export const mildProfanity: LexPack = {
  ...
  entries: [
    ...
    oath("goddamn it", 2), oath("hellfire", 2), oath("damn and blast", 2), oath("bloody Nora", 2), oath("hell and damnation", 2),
    ...
    ins("bloody menace", { band: 2 }), ins("hell-bound wool-sack", { band: 2 }),
  ],
};
...
export const strongProfanity: LexPack = {
  ...
  entries: [
    ...
    ins("prick", { band: 3, targets: ["sheep", "terrain"] }), ins("piss-artist", { band: 3 }), ins("shit-magnet", { band: 3 }), ins("bollock", { band: 3 }),
    adj("shitty", { band: 3 }), adj("pissy", { band: 3 }), adj("bastardly", { band: 3 }), adj("bollocksed", { band: 3 }), adj("shit-stained", { band: 3 }),
  ],
};

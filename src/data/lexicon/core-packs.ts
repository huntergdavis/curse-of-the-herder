...
export const legal: LexPack = {
  ...
  entries: [
    ...
    adj("contumacious", { reg: ["legal"], gloss: "stubbornly disobedient to authority" }),  
     adj("ultra vires", { reg: ["legal"], gloss: "beyond one's powers" }), adj("non-compliant", { reg: ["legal"] }),
    adj("inadmissible", { reg: ["legal"] }), adj("actionable", { reg: ["legal"] }), 
